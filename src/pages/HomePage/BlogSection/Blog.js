        ...
        <section className="blog">
            <div className="container">
                        ...
                        return (
                            <li className="blog__item">
                                ...
                                <div className="blog__details">
                                    ...
                                    <div className="row">
                                        <span>
                                            Comment: <strong>{blog.comment}</strong>
                                        </span>
                                        <span>
                                            View: <strong>{blog.view}</strong>
                                        </span>
                                    </div>
                                    <Buttons.LinkButton path="/blog" linkName="Read now"></Buttons.LinkButton>
                                </div>
                            </li>
                        );
                    })}
                ...
                <div className="blog__cta">
                    <Buttons.LinkButton path="/blog" linkName="Explore All Blogs"></Buttons.LinkButton>
